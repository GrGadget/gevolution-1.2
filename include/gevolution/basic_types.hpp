...
namespace gevolution
{
    ...
    // FIXME: enforce this at compile time of the library of leave it as a template?
    class gadget_serialization
    {
        public:
    ...
    struct type_checks
    {
        ...
        static_assert(sizeof(gadget_serialization::id_type)==8); // serialization of IDs up to 2^64
