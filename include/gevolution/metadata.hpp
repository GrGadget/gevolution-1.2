...
#define GADGET_VELOCITY_CONVERSION                                             \
    3.335640952e-6 // Gadget velocity unit / speed of light
#endif
...
// color escape sequences for terminal highlighting (enable with
// -DCOLORTERMINAL)
#ifdef COLORTERMINAL
...
// header structure for GADGET-2 files [V. Springel, N. Yoshida, and S.D.
